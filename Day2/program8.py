...
# create a dictionary of tools with their names
tools_info = {
...
# get input from user
query = "what is current weather in pune?"
print(f"query = {query}")
...
if hasattr(response, 'tool_calls') and len(response.tool_calls) > 0:
    ...
    tool_to_execute = tools_info[tool['name']]
    result = tool_to_execute.invoke(tool['args'])
